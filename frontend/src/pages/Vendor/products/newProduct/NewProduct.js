...
import { clearErrors, createProduct } from "src/actions/vendorProductAction";
import { useAlert } from "react-alert";
import { NEW_PRODUCT_RESET } from "../../../../constants/vendorProductConstants";
//-------------------------------------------
const optionsUnit = [
...
export default function ProductForm() {
  ...
  const { loading, error, success } = useSelector((state) => state.newVendorProduct);
  ...
  useEffect(() => {
    ...
    if (success) {
      alert.show(
        <div style={{ color: "green" }}>Product added sduccessfully!</div>
      );
      resetForm();
